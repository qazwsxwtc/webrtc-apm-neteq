...
// #include "api/video_codecs/video_codec.h"  // APM: api/video/ removed
// #include "api/video_codecs/video_encoder_config.h"  // APM: api/video/ removed
...
class RateControlSettings final {
 public:
  ...
  // APM: WebRtcKeyValueConfig removed when api/video/ cleanup
  ...
  // APM: VideoCodecMode / VideoEncoderConfig::ContentType removed
 ...
 private:
  // APM: WebRtcKeyValueConfig removed when api/video/ deleted
