...
// #include "api/video_codecs/video_encoder.h"  // APM: api/video/ removed
...
class BalancedDegradationSettings {
 public:
  ...
  // APM: VideoCodecType removed when api/video/ deleted
  ...
  // APM: VideoEncoder::QpThresholds removed when api/video/ deleted
